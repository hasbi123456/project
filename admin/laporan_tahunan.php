...
<head>
    <meta charset="UTF-8">
    <title>Laporan Tahunan - Litera Book Store</title>
    <style>
...
<body>
    <h2>Laporan Penjualan Tahun <?= date('Y') ?></h2>
    <table>
        <tr>
            <th>No</th>
            <th>ID Order</th>
        ...
        <?php endwhile; ?>
        <tr>
            <td colspan="6" class="total">Total Tahun Ini:</td>
